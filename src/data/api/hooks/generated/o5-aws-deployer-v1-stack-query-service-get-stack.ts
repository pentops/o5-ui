...
export function buildO5AwsDeployerV1StackQueryServiceGetStackKey(request?: O5AwsDeployerV1StackQueryServiceGetStackGetStackRequest) {
  const entityId = o5AwsDeployerV1StackStateEntity.getId(request || {}, {}, '');
  if (entityId) return [o5AwsDeployerV1StackStateEntity.key, 'detail', entityId] as const;
...
export function useO5AwsDeployerV1StackQueryServiceGetStack(
  ...
  return useQuery({
    queryKey: buildO5AwsDeployerV1StackQueryServiceGetStackKey(request),
