...
export function buildO5AwsDeployerV1DeploymentQueryServiceListDeploymentsKey(request?: O5AwsDeployerV1DeploymentQueryServiceListDeploymentsRequest) {
  const { page, ...rest } = request || {};
  if (rest) return [o5AwsDeployerV1DeploymentStateEntity.key, 'list', rest] as const;
...
export function useO5AwsDeployerV1DeploymentQueryServiceListDeployments(
  ...
  return useInfiniteQuery({
    queryKey: buildO5AwsDeployerV1DeploymentQueryServiceListDeploymentsKey(request),
