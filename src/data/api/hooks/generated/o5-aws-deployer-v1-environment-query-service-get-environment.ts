...
export function buildO5AwsDeployerV1EnvironmentQueryServiceGetEnvironmentKey(
  request?: O5AwsDeployerV1EnvironmentQueryServiceGetEnvironmentGetEnvironmentRequest,
) {
  const entityId = o5AwsDeployerV1EnvironmentStateEntity.getId(request || {}, {}, '');
  if (entityId) return [o5AwsDeployerV1EnvironmentStateEntity.key, 'detail', entityId] as const;
...
export function useO5AwsDeployerV1EnvironmentQueryServiceGetEnvironment(
  ...
  return useQuery({
    queryKey: buildO5AwsDeployerV1EnvironmentQueryServiceGetEnvironmentKey(request),
