...
export function buildO5AwsDeployerV1DeploymentCommandServiceUpsertEnvironmentKey() {
  return ['/o5.aws.deployer.v1.DeploymentCommandService/UpsertEnvironment'] as const;
}
...
export function useO5AwsDeployerV1DeploymentCommandServiceUpsertEnvironment(
  ...
  return useMutation({
    mutationKey: buildO5AwsDeployerV1DeploymentCommandServiceUpsertEnvironmentKey(),
